...
void ModularBackend::setShakeView(Common::Rect view) {
	_graphicsManager->setShakeView(view);
}

void ModularBackend::removeShakeView() {
	_graphicsManager->removeShakeView();
}
